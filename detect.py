...
def run(
        weights='runs/train/exp8/weights/best.pt',  # model path or triton URL
        source='mydata/images/train',  # file/dir/URL/glob/screen/0(webcam)
        data='data/mydata.yaml',  # dataset.yaml path
